...
public class PaintPrefabWindow : EditorWindow
{
    ...
    public class BrushOptions
    {
        ...
        public BrushOptions(BrushOptions brush)
        {
            ...
            PrefabsParent = brush.PrefabsParent;
        ...
        public override bool Equals(object obj)
        {
            ...
            if (PrefabsParent != brushOpt.PrefabsParent)
                return false;
    ...
    private void OnGUI()
    {
        ...
        activeOptions.PrefabsParent = (Transform)EditorGUILayout.ObjectField(activeOptions.PrefabsParent, typeof(Transform), true, guiOptions);
        GUILayout.EndHorizontal();
        GUILayout.Space(margin * 3f);
    ...
    void PositionObjectProperly(RaycastHit hit)
    {
        for (int i = 0; i < activeOptions.Density; i++)
        {
            ...
            if (Physics.Raycast(point + 0.01f * hit.normal, -hit.normal, out trueHit))
            {
                ...
                GameObject obj = Instantiate(activeOptions.BrushObject);
                ...
                if (activeOptions.PrefabsParent != null)
                    obj.transform.parent = activeOptions.PrefabsParent;
            }
        }
    }
